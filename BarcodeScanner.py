"""
Stregkodescanner v0.9. Til milijømærkningen, programet fungere ved at man klipper et område ud, som skal indeholde en stregkode, programet scanner så billedet
og finder en eventuel stregkode og indsætter den i udklipsholderen
Bygget af TMO 2022/07/13
...
class MyWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Stregkode scanner v0.9")
    ...
    def initUI(self):
        ...
        self.notificationText3.setText("For feedback og hjælp, kontakt tmo@ecolabel.dk")
